...
const countInfo = (state = {selectedData: {}, filter: {status: '', adPcPlace: '', adMobilePlace: ''}, search: {'nickName': '', 'search': '', 'type': 'init'}, pageData: {'currPage': 1, 'pageSize': 20, 'totalCount': 0}, query: {}, list: [], userInfo: {'name': '', 'pwd': ''}, info: {}, replyList: []}, action) => {
