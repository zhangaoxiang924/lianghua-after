...
const coinRecommendInfo = (state = {
    ...
    switch (action.type) {
        case COINRECOMMEND.ADD_DATA:
            return {...state, ...action.data}
        case COINRECOMMEND.ADD_QUERY:
            return {...state, query: {..._query, ...action.data}}
        case COINRECOMMEND.SET_SEARCH_QUERY:
            return {...state, search: {...search, ...action.data}}
        case COINRECOMMEND.SET_PAGE_DATA:
            return {...state, pageData: {...pageData, ...action.data}}
        case COINRECOMMEND.SET_FILTER_DATA:
            return {...state, filter: {...filter, ...action.data}}
        case COINRECOMMEND.EDIT_USER_INFO:
            return {...state, userInfo: {..._userInfo, ...action.data}}
        case COINRECOMMEND.EDIT_LIST_ITEM:
...
export default coinRecommendInfo
