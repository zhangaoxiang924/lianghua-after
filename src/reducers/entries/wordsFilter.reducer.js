...
const wordsFilterInfo = (state = {
    ...
    switch (action.type) {
        case WORDSFILTER.ADD_DATA:
            return {...state, ...action.data}
        case WORDSFILTER.ADD_QUERY:
            return {...state, query: {..._query, ...action.data}}
        case WORDSFILTER.SET_SEARCH_QUERY:
            return {...state, search: {...search, ...action.data}}
        case WORDSFILTER.SET_PAGE_DATA:
            return {...state, pageData: {...pageData, ...action.data}}
        case WORDSFILTER.SET_FILTER_DATA:
            return {...state, filter: {...filter, ...action.data}}
        case WORDSFILTER.EDIT_USER_INFO:
            return {...state, userInfo: {..._userInfo, ...action.data}}
        case WORDSFILTER.EDIT_LIST_ITEM:
...
export default wordsFilterInfo
