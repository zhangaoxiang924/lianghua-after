...
const flashAccountInfo = (state = {
    ...
    switch (action.type) {
        case FLASHACCOUNT.ADD_DATA:
            return {...state, ...action.data}
        case FLASHACCOUNT.ADD_QUERY:
            return {...state, query: {..._query, ...action.data}}
        case FLASHACCOUNT.SET_SEARCH_QUERY:
            return {...state, search: {...search, ...action.data}}
        case FLASHACCOUNT.SET_PAGE_DATA:
            return {...state, pageData: {...pageData, ...action.data}}
        case FLASHACCOUNT.SET_FILTER_DATA:
            return {...state, filter: {...filter, ...action.data}}
        case FLASHACCOUNT.EDIT_USER_INFO:
            return {...state, userInfo: {..._userInfo, ...action.data}}
        case FLASHACCOUNT.EDIT_LIST_ITEM:
...
export default flashAccountInfo
