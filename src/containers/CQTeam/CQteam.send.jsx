...
import {getCQTeamItemInfo, getExchangeInfo} from '../../actions/CQTeam/CQTeam.action'
...
class CQteamSend extends Component {
    constructor (props) {
        super(props)
        this.state = {
    ...
    componentDidMount () {
        ...
        dispatch(getCQTeamItemInfo({'teamId': location.query.id}, (res) => {
            this.setState({
                loading: false
            })
        }))
    ...
    bound = (values) => {
        ...
        const {CQTeamInfo, dispatch} = this.props
        let id = {
            teamId: CQTeamInfo.id,
            passportId: CQTeamInfo.passportId
        }
    ...
    ajaxFn = (data, cb) => {
        const {CQTeamInfo} = this.props
        data.tournamentId = CQTeamInfo.tournamentId || ''
        data.passportId = CQTeamInfo.passportId || ''
                                ...
                                onOk: () => {
                                    if (this.state.noPassReason.trim() !== '') {
                                        ...
                                        this.ajaxFn(values, (resData) => {
                                            ...
                                            // 更新成功后进行修改状态请求
                                            if (resData.code === 1) {
                                                axiosAjax('POST', '/CQTeam/update', sendData, (res) => {
                                                    this.setState({
                                                        loading: false
                                                    })
                                                    if (res.code === 1) {
                                                        message.success(`状态修改成功!`)
                                                        hashHistory.push('/CQTeam-list')
                                                    } else {
    ...
    render () {
        ...
        const {CQTeamInfo, apiList} = this.props
        const {updateOrNot, record, recordVisible} = this.state
        const formItemLayout = {
            labelCol: {span: 1},
            wrapperCol: {span: 18, offset: 1}
        }
        return <div className="CQTeam-send">
                        ...
                        <Col span={11}>
                            <FormItem
                                ...
                                {getFieldDecorator('leaderName', {
                                    initialValue: (updateOrNot && CQTeamInfo) ? `${CQTeamInfo.leaderName}` : '',
                                    rules: [{required: true, message: '请输入领队姓名！'}]
                                })(
                                    <Input ref={(input) => { this.input = input }} className="CQTeam-author" placeholder="请输入领队姓名"/>
                                )}
                            </FormItem>
                        </Col>
                        <Col span={11}>
                            <FormItem
                                ...
                                {getFieldDecorator('leaderMail', {
                                    initialValue: (updateOrNot && CQTeamInfo) ? `${CQTeamInfo.leaderMail}` : '',
                                    rules: [{required: true, message: '请输入领队邮箱！'}]
                                })(
                                    <Input className="CQTeam-author" placeholder="请输入领队邮箱"/>
                                )}
                            </FormItem>
                        </Col>
                        <Col span={11}>
                            <FormItem
                                ...
                                {getFieldDecorator('leaderPhone', {
                                    initialValue: (updateOrNot && CQTeamInfo) ? `${CQTeamInfo.leaderPhone}` : '',
                                    rules: [{required: true, message: '请输入领队电话！'}]
                                })(
                                    <Input className="CQTeam-author" placeholder="请输入领队电话"/>
                                )}
                            </FormItem>
                        </Col>
                        <Col span={11}>
                            <FormItem
                                ...
                                {getFieldDecorator('companyName', {
                                    initialValue: (updateOrNot && CQTeamInfo) ? `${CQTeamInfo.companyName}` : '',
                                    rules: [{required: true, message: '请输入公司名！'}]
                                })(
                                    <Input className="CQTeam-author" placeholder="请输入公司名"/>
                                )}
                            </FormItem>
                        </Col>
                        <Col span={11}>
                            <FormItem
                                ...
                                {getFieldDecorator('leaderTitle', {
                                    initialValue: (updateOrNot && CQTeamInfo) ? `${CQTeamInfo.leaderTitle}` : '',
                                    rules: [{required: true, message: '请输入领队职务！'}]
                                })(
                                    <Input className="CQTeam-author" placeholder="请输入领队职务"/>
                                )}
                            </FormItem>
                        </Col>
                    </Row>
                        ...
                        <Col span={11}>
                            <FormItem
                                ...
                                {getFieldDecorator('name', {
                                    initialValue: (updateOrNot && CQTeamInfo) ? `${CQTeamInfo.name}` : '',
                                    rules: [{required: true, message: '请输入队伍名称！'}]
                                })(
                                    <Input className="CQTeam-author" placeholder="请输入队伍名称"/>
                                )}
                            </FormItem>
                        </Col>
                        <Col span={11}>
                            <FormItem
                                ...
                                {getFieldDecorator('memberCount', {
                                    initialValue: (updateOrNot && CQTeamInfo) ? `${CQTeamInfo.memberCount}` : 0,
                                    rules: [{required: true, message: '请输入团队人数！'}]
                                })(
                                    <Input className="CQTeam-author" placeholder="请输入团队人数"/>
                                )}
                            </FormItem>
                        </Col>
                        <Col span={11}>
                            <FormItem
                                ...
                                {getFieldDecorator('description', {
                                    initialValue: (updateOrNot && CQTeamInfo) ? `${CQTeamInfo.description}` : '',
                                    rules: [{required: true, message: '请输入团队简介！'}]
                                })(
                                    <TextArea className="CQTeam-summary" rows={8} placeholder="请输入团队简介"/>
                                )}
                            </FormItem>
                        </Col>
                        <Col span={11}>
                            <FormItem
                                ...
                                {getFieldDecorator('declaration', {
                                    initialValue: (updateOrNot && CQTeamInfo) ? `${CQTeamInfo.declaration || ''}` : '',
                                    rules: [{required: true, message: '请输入团队简介！'}]
                                })(
                                    <TextArea className="CQTeam-summary" rows={8} placeholder="请输入团队宣言"/>
                                )}
                            </FormItem>
                        </Col>
                        <Col span={11}>
                            <FormItem
                                ...
                                {getFieldDecorator('recommendType', {
                                    initialValue: (updateOrNot && CQTeamInfo) ? `${CQTeamInfo.recommendType}` : '无',
                                    rules: [{required: false, message: '请输入推荐机构！'}]
                                })(
                                    <Input className="CQTeam-author" placeholder="请输入推荐机构"/>
                                )}
                            </FormItem>
                        </Col>
                        ...
                        <Col span={11}>
                            <FormItem
                                ...
                                {getFieldDecorator('autoFetchBalance', {
                                    initialValue: CQTeamInfo.autoFetchBalance,
...
const mapStateToProps = (state) => {
    return {
        CQTeamInfo: state.CQTeamInfo.info,
        apiList: state.CQTeamInfo.apiList
    }
}

export default connect(mapStateToProps)(Form.create()(CQteamSend))
