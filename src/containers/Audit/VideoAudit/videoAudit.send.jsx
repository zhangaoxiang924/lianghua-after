...
class VideoAuditSend extends Component {
    ...
    componentDidMount () {
        ...
        if (location.query.id || location.query.url) {
            dispatch(getVideoAuditItemInfo({'id': location.query.id}, (res) => { this.renderData(res) }))
        } else {
            this.setState({
                loading: false
            })
                    ...
                    >
                        <div className="dropbox">
                            {getFieldDecorator('video_pc', {
                                ...
                                rules: [{required: false, message: '请上传视频 PC 端播放器封面！'}]
                            })(
                                <Upload
                                    headers={{'Sign-Param': getSig()}}
                                    action={`${URL}/pic/upload`}
                                    ...
                                    onPreview={this.handlePreview}
                                    onChange={this.handleVideoAuditPcChange}
                                >
                    ...
                    >
                        <div className="dropbox">
                            {getFieldDecorator('video_m', {
                                ...
                                rules: [{required: false, message: '请上传视频 M 端播放器封面！'}]
                            })(
                                <Upload
                                    headers={{'Sign-Param': getSig()}}
                                    action={`${URL}/pic/upload`}
                                    ...
                                    onPreview={this.handlePreview}
                                    onChange={this.handleVideoAuditMChange}
                                >
