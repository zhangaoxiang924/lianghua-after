...
import {getTeamItemInfo} from '../../actions/team/team.action'
...
class TeamDetail extends Component {
    ...
    componentWillMount () {
        ...
        dispatch(getTeamItemInfo({'teamId': location.query.id}, () => {
            this.setState({
                loading: false
            })
        }))
    ...
    render () {
        ...
        return <Spin spinning={this.state.loading} size="large">
            {info.id ? <div className="team-detail">
                <Row>
                    <Col span={1}>
                ...
                <Row className="team-detail-info">
