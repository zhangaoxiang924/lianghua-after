    ...
    handleSubmit = (e) => {
        ...
        this.props.form.validateFieldsAndScroll((err, values) => {
            if (!err) {
                ...
                axiosAjax('post', '/partner/update', values, (res) => {
                    if (res.code === 1) {
                        message.success('修改成功')
                        hashHistory.push('/partner-list')
                    } else {
...
const mapStateToProps = (state) => {
    return {
        selectContent: state.partnerInfo.selectedData
    }
}

export default connect(mapStateToProps)(Form.create()(PartnerEdit))
